...
//
// $Id: awbidtnf.cpp 1.57 12/19/2024 12:21:56 Olson,DavidJ. $
...
// <summary>Benefit increases, 1951-2024.</summary>
...
// <summary>Average wage index, 1937-2023.</summary>
const double AwbiDataNonFile::fqData[] = {
  ...
  60575.07, 63795.13, 66621.80
};

// <summary>OASDI taxable maximum, 1937-2025.</summary>
const double AwbiDataNonFile::baseOasdiData[] = {
 ...
 142800.00, 147000.00, 160200.00, 168600.00, 176100.00
};

// <summary>HI taxable maximum, 1991-2025.</summary>
...
// <summary>Old-law taxable maximum, 1937-2025.</summary>
const double AwbiDataNonFile::base77Data[] = {
 ...
 106200.00, 109200.00, 118800.00, 125100.00, 130800.00
};
